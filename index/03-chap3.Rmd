...
```{r soilAob, echo=FALSE, fig.cap="Soil amoA bacteria estimation", fig.asp=}
soilaob
```
...
*amoA* gene copy numbers are in the ranges of 10,000 - 40,000 in the soil samples (Figure \@ref(fig:. In the control gene copy numbers are higher in the second timepoint than the first. No clear pattern between timepoints is observable for the treated plots. The mean of differences of the fully treated plots is the most negative mean of differences (-8310). The upper and lower limits of the fully treated plots are negative. The fertilized and the fungicide + growth regulator treated plots have also negative lower CI limits, but a positive upper limit. Their mean of differences is also negative with -3500 for the fertilized and -1010 for the fungicide and growth regulator treated plots. 

```{r soilAoa, echo=FALSE, fig.cap="Rhizo amoA archaea estimation"}
soilaoa
```

In the rhizosphere samples the gene copy numbers of archaea *amoA* have a higher range between 1,000,000 - 3,000,000 
