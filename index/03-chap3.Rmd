...
```{r soilAob, echo=TRUE, fig.cap="Soil amoA bacteria estimation"}
soilaob
```
...
```{r rhizoAob, echo=TRUE, fig.cap="Rhizo amoA bacteria estimation"}
rhizoaob
```
