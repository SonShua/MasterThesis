...
\begin{ucfrontmatter}
  ...
  \report{Dissertation} \degree{Master of Science} \degreemonth{$degree_month$} \degreeyear{$degree_year$}
  \defensemonth{$defense_month$}
  \defenseyear{$defense_year$}

  \chair{$advisor$}  % this is your advisor
  \othermemberA{$altadvisor$} % This is a member of your committee
